...
class MPC_controller(Node):
    ...
    def init_state(self):
        ...
        self.obs_states     = np.array( [ [ [  0.7], [  0.2]],
                                          [ [  0.7], [  1.3]],
                                          [ [  0.5], [ -0.8]] ], dtype=np.float64)
        
        self.obs_start_vel  = np.array( [ [ [ -1], [ -0.5]],
                                          [ [    0], [    0]],
    ...
    def timer_callback(self):
        ...
        objs_avoid_weight       = np.array( [1000,100,100, 100])
        i= 0
        for obs in self.obs_list.obstacles.values():
            ...
            if collide_states.any() :
                ...
                i = i + 1
                print("obj_ref_path_val :" , obj_ref_path_val)
                print("obj_ref_path_Qval :", obj_ref_path_Qval)
